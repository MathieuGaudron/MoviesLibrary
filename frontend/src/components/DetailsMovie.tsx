...
const DetailsMovie: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-8 min-h-screen flex flex-col items-center justify-center font-sans">
      <div className="absolute top-4 left-4">
        <div
          onClick={() => navigate(-1)}
          className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-purple-600 via-violet-500 to-purple-600 rounded-full cursor-pointer hover:scale-110 transition-transform duration-300 shadow-lg hover:bg-indigo-500"
        >
          <svg
      ...
      <div className="w-full max-w-6xl rounded-lg shadow-lg border border-gray-700 bg-gradient-to-r from-purple-900 via-indigo-900 to-purple-900">
  <div className="flex flex-wrap lg:flex-nowrap items-center lg:items-start gap-8 p-6 sm:p-8">
    <img
    ...
    <div className="flex flex-col gap-4 w-full text-center lg:text-left">
      <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-indigo-200 via-purple-300 to-indigo-200 bg-clip-text text-transparent">
        {movie.title}
      </h1>
